...
const routes: Routes = [
  ...
  {
    path: 'customers',
    loadChildren: () => import('./folder/pages/customers/customers.module').then( m => m.CustomersPageModule)
  },
  {
    path: 'profile',
  ...
  {
    path: 'about-us',
    loadChildren: () => import('./folder/pages/about-us/about-us.module').then( m => m.AboutUsPageModule)
  }
];
